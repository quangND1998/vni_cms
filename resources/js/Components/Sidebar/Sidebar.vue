      ...
      <div
        ...
        <ul v-if="$page.props.auth.user == null" class="md:flex-col md:min-w-full flex flex-col list-none md:mb-4">
          ...
          <li class="items-center">
            <Link class="text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"
              :href="route('register')">
            <icon name="book" class=" text-blueGray-300 mr-2 text-sm"></icon>
            Register
            </Link>
          </li>
        </ul>
        ...
        <ul class="md:flex-col md:min-w-full flex flex-col list-none md:mb-1 " lass="relative">
          ...
          <Link :class="[$page.url.startsWith('/admin/pages') ? 'opacity-75 text-blue-300 bg-coolGray-900' : '']"
            :href="route('pages')"
          ...
          <Link :class="[$page.url.startsWith('/admin/themes') ? 'opacity-75 text-blue-300 bg-coolGray-900 ' : '']"
            :href="route('themes.index')"
            class=" px-4 py-2.5 flex flex-wrap text-blueGray-300 hover:text-blueGray-400 text-sm  mb-1 no-underline font-semibold">
          <icon name="theme" class="mr-1 text-blueGray-300 text-base"></icon>
          Theme
          </Link>
          <Link :class="[$page.component === 'Language' ? 'opacity-75 text-blue-300 bg-coolGray-900 ' : '']"
          ...
          <Link :class="[$page.component === 'Mail/Mail' ? 'opacity-75 text-blue-300 bg-coolGray-900 ' : '']"
            :href="route('mail.index')"
            class=" px-4 py-2.5 flex flex-wrap text-blueGray-300 hover:text-blueGray-400 text-sm  mb-1 no-underline font-semibold">
          <icon name="mail" class="mr-1 text-blueGray-300 text-base"></icon>
          Mail
          </Link>
          <Link :class="[$page.component === 'Contact' ? 'opacity-75 text-blue-300 bg-coolGray-900 ' : '']"
          ...
          <li class="inline-flex"></li>



          <Link :href="route('logout')" method="post"
            class=" px-4 py-2.5 flex flex-wrap text-blueGray-700 hover:text-blueGray-400 text-sm  mb-1 no-underline font-semibold"
