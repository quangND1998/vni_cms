...
function sendRegEmail() {
	...
	var phone_number = document.forms['email_register']['phone_number'].value;
	var slug = document.forms['email_register']['slug'].value;
	...
	if(test==false) {
		...
		$.ajax({ 
			url:'/action.php',
			type: 'POST',
			data: 'url=register_email&email='+email+'&phone_number='+phone_number+'&lang='+lang+'&slug='+slug,
			dataType: "html",
			success: function(data){
				closeLoader();
				$('#_reg_email').val('');
				$('#_reg_phone_number').val('');
				alert(data);
			}
		});
	}
