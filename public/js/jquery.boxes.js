	...
	var methods = {
		init: function(options) {
			var setting = $.extend({
				...
				title: 'Thông báo',
				message: '',
				okBtn: '<img src="../images/alert.svg" class="okne">Đồng ý',
				cancelBtn: 'Hủy',
				closeBtn: 'Đóng',
				inputTxt: '',
			...
			var tpl = {
				...
				overlay: '<div class="zzBoxes_overlay"></div>',
				inner: '<div class="zzBoxes_inner"></div>',
				header: '<div class="zzBoxes_header"></div>',
				title: '<h2 class="zzBoxes_title"></h2>',
				close: '<div class="zzBoxes_close"></div>',
				content: '<div class="zzBoxes_content"></div>',
				mess: '<div class="zzBoxes_mess"></div>',
			...
			var helper = {
				...
				center: function(setHeight, setWidth) {
					...
					if ($mess) {
						...
						var newHeight = boxHeight - (titleHeight + inputHeight + headerHeight + buttonHeight + padding[0] * 2);
						if (newHeight < 0) {
							helper.effect('error');
						} else {
